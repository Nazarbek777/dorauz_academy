                            ...
                            <div class="tab-pane fade show active" id="profileTab" role="tabpanel">
                                <div class="card-body personal-info">
                                    <form action="{{ route('groups.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <label for="day_table" class="form-label">Vaqt jadvali</label>
                                            <input type="text" class="form-control" id="day_table" name="time_table" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="day_table" class="form-label">Kun jadvali</label>
                                            <input type="text" class="form-control" id="day_table" name="day_table" required>
                                        </div>
