            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Shartnoma yaratish</li>
                    </ul>
                </div>
                                ...
                                <div class="card-body p-0">
                                        ...
                                        <div class="d-md-flex align-items-center justify-content-between">
                                            ...
                                            <div class="d-md-flex align-items-center justify-content-end gap-4">
                                                <div class="form-group mb-3 mb-md-0">
                                                    ...
                                                    <input type="date" id="issueDate" class="form-control" name="date" placeholder="Issue date...">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row px-4 justify-content-between">
                                        <div class="col-xl-5 mb-4 mb-sm-0">
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="InvoiceName" name="name" placeholder="Business Name">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label for="InvoiceEmail" class="col-sm-3 col-form-label">Email</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="InvoiceEmail" name="email" placeholder="Email Address">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-3">
                                                <label for="InvoicePhone" class="col-sm-3 col-form-label">Phone</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="InvoicePhone" name="phone" placeholder="Enter Phone">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="InvoiceAddress" class="col-sm-3 col-form-label" >Address</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="InvoiceAddress" name="address" placeholder="Enter Address">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-5">
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="ClientPhone" value="306334591" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                    ...
                                    <div class="px-4 pb-4">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="6" class="form-control" id="InvoiceNote" name="comment" placeholder="It was a pleasure working with you and your team. We hope you will keep us in mind for future freelance projects. Thank You!"></textarea>
                                        </div>
                                    </div>
                                    <div class="row  mt-3">
                                        <div class="col-lg-12">
