            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Shartnomani ko'rish</li>
                    </ul>
                </div>
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        ...
                        <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                            ...
                            <a href="/public/payment/edit" class="btn btn-primary">
                    ...
                    <div class="col-xl-8">
                        <div class="card invoice-container">
                            <div class="card-header">
                                <h5>Shartnomani ko'rish</h5>
                                <div class="dropdown">
                                    <a href="javascript:void(0)" class="btn btn-light-brand dropdown-toggle" data-bs-toggle="dropdown" data-bs-offset="0,25" disabled>Yo'nalish tanlang</a>
                                    ...
                                    <div class="d-md-flex align-items-center justify-content-between">
                                        ...
                                        <div class="d-md-flex align-items-center justify-content-end gap-4">
                                            <div class="form-group mb-3 mb-md-0">
                                                ...
                                                <input type="date" id="issueDate" class="form-control" value="2024-02-02" placeholder="Issue date..." disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="px-4 row justify-content-between">
                                    <div class="col-xl-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="InvoiceLabel" value="Suhrob Baxtiyorov" disabled>
                                        </div>
                                    </div>
                                    <div class="col-xl-3">
                                        <div class="form-group mb-3">
                                            <label for="InvoiceNumber" class="form-label">Unikal ID</label>
                                            <input type="text" class="form-control" id="InvoiceNumber" value="DA-0001" disabled>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="form-group mb-3">
                                            <label for="InvoiceProduct" class="form-label">Maxsulot nomi</label>
                                            <input type="text" class="form-control" id="InvoiceProduct" placeholder="SMM" value="SMM" disabled>
                                        </div>
                                    </div>
                                </div>
                                <hr class="border-dashed">
                                <div class="row px-4 justify-content-between">
                                    <div class="col-xl-5 mb-4 mb-sm-0">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="InvoiceName" value="MAXDORA" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label for="InvoiceEmail" class="col-sm-3 col-form-label">Email</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="InvoiceEmail" value="info@dora.uz" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label for="InvoiceInn" class="col-sm-3 col-form-label">INN</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="InvoiceInn" value="306334591" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="InvoiceAddress" class="col-sm-3 col-form-label">Address</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="InvoiceAddress" value="Toshkent shahar, chilonzor 2/2" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-5">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="ClientName" value="MAXDORA" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label for="ClientEmail" class="col-sm-3 col-form-label">Email</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="ClientEmail" value="info@dora.uz" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label for="ClientInn" class="col-sm-3 col-form-label">INN</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="ClientInn" value="306334591" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="ClientAddress" class="col-sm-3 col-form-label">Address</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="ClientAddress" value="Toshkent shahar, chilonzor 2/2" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="nav nav-justified gap-1">
                                    <li class="nav-item border border-gray-500">
                                        <a href="javascript:void(0);" class="nav-link px-2 active" data-bs-toggle="tab" data-bs-target="#pamymetDebitCardTab" disabled>
                                            <i class="bi bi-credit-card-fill"></i>
                                            <span class="ms-2">Debit Card</span>
                                        </a>
                                    </li>
                                    <li class="nav-item border border-gray-500">
                                        <a href="javascript:void(0);" class="nav-link px-2" data-bs-toggle="tab" data-bs-target="#pamymetPaypalTab" disabled>
                                ...
                                <div class="tab-content mt-4">
                                    <div class="tab-pane fade show active" id="pamymetDebitCardTab" role="tabpanel">
                                        <div class="form-group mb-3">
                                            <input type="text" class="form-control input-credit-card" value="Card Number" disabled>
                                        ...
                                        <div class="form-group mb-3">
                                            <input type="text" class="form-control" value="Card Holder Name" disabled>
                                        </div>
                                        <div class="d-flex gap-3">
                                            <div class="form-group">
                                                <input type="text" class="form-control input-date-formatting" value="MM/YYYY" disabled>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control input-Blocks-formatting" value="686" disabled>
                                            </div>
                                        </div>
                                    </div>
